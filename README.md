...
| 4 | Late chunking — when it helps, when it hurts | Intermediate | In progress | [ep04-late-chunking/](ep04-late-chunking/) |
| 5 | Hybrid search (BM25 + dense + RRF) | Intermediate | Pending | _coming soon_ |
| 6 | Query rewriting (HyDE / multi-query / step-back) | Advanced | Pending | _coming soon_ |
| 7 | RAG tools compared (LangChain / LlamaIndex / Haystack / custom) | Advanced | Pending | _coming soon_ |
| 8 | Evaluation (RAGAS, golden sets) | Advanced | Pending | _coming soon_ |
| 9 | Production (caching, monitoring, cost) | Advanced | Pending | _coming soon_ |
